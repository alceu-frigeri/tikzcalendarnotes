...
\tscode*
  [
    keywd={calendarnotes,defnewdataset,setdates,setcountingweeks,sethighlightdates},
...
Lastly, in case ones wants an expanded view of a single, out of order, month you can use the \tsobj[key]{starting at} from \tsobj{\setcountingweeks} (note that, if the \tsobj[key]{from,to} keys are the same, it will just redefine the already existent counter, and not create a new one.
...
%\ExplSyntaxOn
%\tl_new:N \l__xxx_tl
%\tl_set:Nn \l__xxx_tl {5em}
%
%\fp_eval:n {2 * \l__xxx_tl} \par
%
%
%\fp_eval:n {2 * (5em)} \par
%
...
%
%    {
%      \tl_gset:Ne \g_tmpa_tl {\f@size}
%      \tl_set:Ne \l_tmpa_tl {\fp_eval:n {1ex}}
%      \tl_show:N \g_tmpa_tl
%      \tl_show:N \l_tmpa_tl
%    }
%
